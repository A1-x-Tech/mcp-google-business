 ...
 * environment versions ever leave the machine. OAuth credentials, account data,
 ...
 * partial OAuth trio); it is kept unchanged so the historical funnel stays
